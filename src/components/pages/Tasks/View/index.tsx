    ...
    <>
        ...
        <HeroInner>
          <div>
            ...
            <Sub>
              ...
              them inside projects; anyone with access can claim one. The result
              becomes a public worklog — the most honest portfolio that exists.
            </Sub>
          </div>
          <WhyStrip>
            <WhyItem>
      ...
      <Section>
        <Container>
          ...
          <SectionLede>Pulled from active projects in the network.</SectionLede>
          <Grid $cols={3}>
            {tasks.map((n) => {
          ...
          <CrossLinks>
            ...
            <CrossCard href="/offers">
              ...
              <span>Turn it into an offer so others come to you instead.</span>
              <em>See offers</em>
            </CrossCard>
          </CrossLinks>
        </Container>
