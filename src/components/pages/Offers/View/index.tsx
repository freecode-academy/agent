...
export const OffersPageView: React.FC<OffersPageViewProps> = ({ offers }) => {
  return (
    <>
      <Hero>
        <HeroInner>
        ...
        <Container>
          ...
          <CrossLinks>
            ...
            <CrossCard href="/projects">
              ...
              <span>And projects spawn tasks. The full chain works here.</span>
              <em>See projects</em>
            </CrossCard>
          </CrossLinks>
        </Container>
