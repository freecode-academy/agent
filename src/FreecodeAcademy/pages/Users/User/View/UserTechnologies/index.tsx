...
import { userTechnologiesLexicon } from './lexicon'
...
export const UserTechnologies: React.FC<UserTechnologiesProps> = ({
  ...
  const { t } = useLexicon(userTechnologiesLexicon)
  ...
  return (
    <UserTechnologiesStyled>
      <UserTechnologiesGridStyled>
        <UserTechnologiesRowHeaderStyled>
          <UserTechnologiesCellStyled>
            {t('userTechnologies.headers.technology')}
          </UserTechnologiesCellStyled>
          <UserTechnologiesCellStyled>
            {t('userTechnologies.headers.level')}
          </UserTechnologiesCellStyled>
          <UserTechnologiesCellStyled>
            {t('userTechnologies.headers.period')}
          </UserTechnologiesCellStyled>
          <UserTechnologiesCellStyled>
            {t('userTechnologies.headers.status')}
          </UserTechnologiesCellStyled>
          <UserTechnologiesCellStyled>
            {t('userTechnologies.headers.hiring')}
          </UserTechnologiesCellStyled>
          ...
          <UserTechnologiesButtonsStyled>
            ...
            >
              {inEditMode || technologiesResponse.loading
                ? t('userTechnologies.buttons.cancel')
                : t('userTechnologies.buttons.editTechnologies')}
            </Button>
          </UserTechnologiesButtonsStyled>
        </>
      )}
